...
> **Hinweis zur Topologie:** Der Auftrag beschreibt als Endzustand "1 Master + 2 Workers". In meinem Setup wurden node1 und node2 beim initialen Join beide als Master hinzugefügt (ohne `--worker` Flag), und nur node3 wurde als Worker neu hinzugefügt. Das Resultat ist daher **2 Master + 1 Worker**. Der geforderte Schritt — einen Node entfernen und als Worker wieder hinzufügen — wurde korrekt durchgeführt und ist vollständig dokumentiert. Das Konzept und die Befehle sind identisch; die Anzahl der Master/Worker weicht vom Beispiel im Auftrag ab.
