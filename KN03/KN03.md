...
> **Hinweis zum Subnet:** Der Auftrag gibt `172.18.0.0/16` vor. Dieses Subnet war auf meinem System bereits durch ein bestehendes Docker-Netzwerk belegt (`docker network ls` zeigte ein Netzwerk mit `172.18.0.0/16`). Da zwei Netzwerke nicht den gleichen IP-Range haben können, wurde `172.21.0.0/16` als Ersatz verwendet. Das Verhalten und die Testergebnisse sind identisch.
...
- `ping 172.17.0.6` (busybox2, anderes Netzwerk) → **Fehlgeschlagen**
